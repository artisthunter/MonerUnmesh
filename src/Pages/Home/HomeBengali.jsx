      ...
      <div className="page-container">
        <div className="main-card">
          ...
          <div className="slogans">
            ...
            চেতনাভিত্তিক একটি বিকল্প শিক্ষা প্রতিষ্ঠান।
          </div>

          <div className="slogans">
            বিকল্প শিক্ষা,
            <br />
            বিষয়বস্তুতে দৃষ্টি দেওয়া শেখায় না
            <br />
            দৃষ্টির ভিতরে বোধ জাগিয়ে তোলে।।
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <h2 className="section-header">
            ...
            মনের উন্মেষের উদ্যোক্তা
          </h2>
          <h3 className="text-content">
            মনের উন্মেষ উদ্ভাবনের প্রেক্ষাপট যোগীরাজ অলোক কুমার দাস দীর্ঘদিন
            হিমালয়ে গুহাবাসী হয়ে যোগসাধনা করে উপনিষদীয় আত্মবিদ্যা সম্বন্ধে যা
            কিছু উপলব্ধি করেছেন সেই বিদ্যা এবং আধুনিক যুগের Cognitive science এর
            মিথস্ক্রিয়ায় এক নতুন শিক্ষা পদ্ধতি উদ্ভাবন করেছেন। এই নতুন বিদ্যাকে
            পরবর্তিকালে আবার কিছু সংস্কার করে প্রচলিত প্রাতিষ্ঠানিক শিক্ষার
            বিকল্প শিক্ষা হিসেবে উপযোগী করে তুলেছেন। তিনি এই বিকল্প শিক্ষা
            পদ্ধতি প্রয়োগের জন্য ঝাড়্গ্রাম, পশ্চিম মেদিনীপুর, জঙ্গল মহল এলাকার
            আদিবাসী সমাজের First generation learner শিশুদের বেছে নিয়েছেন। এই
            উদ্দেশ্যে মনের উন্মেষ নামে এক non formal স্কুল শুরু করে ওই আদিবাসী
            শিশুদের যাতে শিক্ষিত করে তোলা যায় তা নিয়ে এখনো গবেষণা করে যাচ্ছেন।
          </h3>
          ...
          <p className="text-content">
            <ul className="clean-list">
              <li>
                বিষয়বস্তুতে দৃষ্টি দেওয়া শেখায় না দৃষ্টির ভিতরে বোধ জাগিয়ে
                তোলে।।
              </li>
              <li>সংযোগ বা সংগ্রহের শিল্প।</li>
              <li>শেখায় শুধু তথ্য গ্রহন নয় তথ্যের অর্থ গ্রহনই হল শিক্ষা।</li>
          ...
          <p className="text-content">
            ...
            <ul className="clean-list">
              ...
              <li>ভাষা, চিন্তা, সিদ্ধান্ত, চেতনা কীভাবে কাজ করে?</li>
            ...
            <br />
            পাতঞ্জল ঋষির যোগ সম্বন্ধে প্রথম উপদেশ হল --- যোগশ্চিত্তবৃত্তি
            নিরোধ।।
            <br />
            ...
            রূপদান করেছেন।
            <br />
            চিত্ত বৃত্তির নিরোধই হল যোগ। এইটাই শ্লোকের অর্থ। এই চিত্ত কি? মন
            ইন্দ্রিয়ের মাধ্যমে প্রকৃতি থেকে এবং শরীরের ভিতর থেকে সমস্ত তথ্য
            ...
            শিক্ষা। ব্যাস, এই ভাবনাকেই তিনি ধীরে ধীরে বিকল্প শিক্ষার উপযোগী করে
            তোলেন। তিনি বলেন জ্ঞান বাড়ানো যায় না জ্ঞানের ভাণ্ডার বৃদ্ধি হয়।
            জ্ঞান হল সংযোগ প্রক্রিয়া। মন ইন্দ্রিয়ের মাধ্যমে সমস্ত তথ্যকে যে
            প্রক্রিয়ায় সংগ্রহ করে মস্তিষ্কের চিত্ত নামক শক্তির কাছে পাঠায় এবং
            চেতনার সাথে সংযোগ করায় সেই প্রক্রিয়াই হল জ্ঞান। এই প্রক্রিয়াতেই
            বিকল্প শিক্ষার বীজ লুকিয়ে আছে।
          </p>
          ...
          <p className="text-content">
            মনের উন্মেষ এর চেতনা ভিত্তিক বা চৈতিক দৃষ্টিকোণ :- এই বিদ্যালয় মানুষ
            তৈরি করতে চায় না, মানুষকে তার নিজের কাছে স্পষ্ট করাতে চায়।
            <br />
            <br />
            ...
            <br />
            <br />
            শিক্ষার্থীর মনের ভাবের সাথে বাইরের প্রকৃতির এবং নিজের ভিতরের তথ্য
            আদির সংযোগের প্রক্রিয়া হল শিক্ষা।
            <br />
            না জানা বা কম জানা বা ভুল জানা --অপরাধ নয়।
            <br />
            শিক্ষক- ছাত্র পারস্পরিক সম্পর্ক হল গভীর ভয়মুক্ত নির্ভরযোগ্য সম্পর্ক।
            <br />
            প্রশ্ন করার ভয় লজ্জা অপসারন করা।
            <br />
            <br />
            <strong>
          ...
          <p className="text-content">
            ...
            <ul className="clean-list">
              <li>
                অবজারভার, অবজারভেশন ও অবজেক্ট এই তিনকে আলাদা ভাবা অভ্যাস করার
                মধ্য দিয়ে শিক্ষার শুরু।
              </li>
              <li>
            ...
            <ul className="clean-list">
              ...
              <li>
                আগে থেকে জমে থাকা ধারনা (স্মৃতি৷) বর্তমানের উপলব্ধিকে বিকৃত করে।
              </li>
            ...
            <ul className="clean-list">
              <li>উপনিষদ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Cognitive science.</li>
              <li>
                {" "}
                অবিদ্যা &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; cognitive bias/
                conditioning.
              </li>
              <li>
                {" "}
                সাক্ষীভাব &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Observation/Meta
                cognition.
              </li>
              <li>বিদ্যা &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Clear seeing.</li>
              <li>আবরণ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Mental model.</li>
            </ul>
            <br />
            <quote>
          ...
          <p className="text-content">
            প্রকৃতি যেমন : আমরা কিন্তু তেমন দেখিনা।
            <br />
            আমরা যেমন : প্রকৃতি সেইভাবে ধরা দেয়।
            <br />
            ...
            স্মৃতি ও ভাষার সাথে সংযোগ হয় আর সংযোগের প্রকাশ হয় চেতনায়।এই সংযোগ
            হওয়াকেই প্রচলিত ভাষায় জ্ঞান হওয়া বলে। আর এই সংযোগ হওয়ার প্রক্রিয়াকেই
            বলে শিক্ষন প্রক্রিয়া। যিনি এই শিক্ষন প্রক্রিয়ায় গাইড বা মেন্টর
            হিসেবে কাজ করেন তিনিই হলেন শিক্ষক বা শিক্ষিকা।
            <br />
            শিক্ষক যেভাবে শেখান : শিক্ষকের কাজ স্মৃতিতে তথ্যের ভাণ্ডার বৃদ্ধি
            করা নয়। সংযোগ প্রক্রিয়ায় যে যে বাধা আসে সেই বাধা অপসারন করাই হল
            শিক্ষকের কাজ। তাই শিক্ষকের কাজ কিছু দেওয়া বা যোগ করা নয় বাদ দেওয়া বা
            অপসারন করা।
            <br />
            <br />
            ...
            <br />
            <br />
            অতএব : শিক্ষা কিন্তু জ্ঞান দেওয়া নয়।
            <li>তথ্য</li>
            <li>অভিজ্ঞতা</li>
            <li>স্মৃতি</li>
            <li>ভাষা</li>
            ...
            তাহলে শিক্ষা কি করে :
            <br />
            শিক্ষার্থীকে প্রশ্ন করার সাহস যোগায়।
            <br />
            ভয়মুক্ত করে, বিনম্র করে।
            <br />
            শুধু দেখা নয়, দেখার ভিতরে বোধ তৈরি করে।
            <br />
            বিষয়ের গভীরতা উপলব্ধি করে নিজস্ব মতামত তৈরি করে।
            <br />
            প্রতিযোগিতা নয় আন্তরিকতা উপলব্ধি করে।
            <br />
            পার্থক্য বোঝে।
            <br />
            বিচ্ছিন্ন ঘটনাকে একসূত্রে গাঁথে।
            <br />
            জ্ঞান = সংযোগ, যা বৃদ্ধি করা যায় না।
            <br />
            শিক্ষা = সংযোগের জন্য বাধা অপসারন।
            <br />
